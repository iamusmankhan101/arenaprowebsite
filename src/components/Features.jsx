            ...
            <div className="features-container">
                ...
                <div className="features-grid">
                    ...
                    <div className="feature-card mofin-yellow">
                        ...
                        <div className="mofin-visual-right-small" style={{ right: '10px', bottom: '-130px' }}>
                            <img src="/image/refer.png" alt="Refer and Earn" style={{ width: '360px', height: '360px', objectFit: 'contain' }} />
                        </div>
                    </div>
                    ...
                    <div className="feature-card" style={{ background: 'transparent', boxShadow: 'none' }}>
                        ...
                        <div className="mofin-visual-right-small" style={{ right: '110px', bottom: '-30px' }}>
