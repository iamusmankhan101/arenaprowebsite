                    ...
                    <div className="download-buttons-group">
                        <button className="dl-btn apple-dl-btn">
                            ...
                            <div className="dl-btn-text">
                                <span className="dl-small-text">Available on the</span>
                                <span className="dl-large-text">App Store</span>
                            </div>
                        </button>

                        <button className="dl-btn google-dl-btn">
                            <div className="dl-btn-icon">
                                <img src="/image/pngtree-google-play-app-icon-vector-png-image_9183316.png" alt="Google Play Icon" style={{ width: '24px', height: 'auto' }} />
                            </div>
                            <div className="dl-btn-text">
                                <span className="dl-small-text">ANDROID APP ON</span>
                                <span className="dl-large-text">Google Play</span>
                            </div>
                        </button>
                    </div>
