...
export default function AddVenueModal({ open, onClose, editVenue = null, vendorId = null }) {
  ...
  const [autoGenerated, setAutoGenerated] = useState(false); // Track if 7 days were auto-generated
  ...
  useEffect(() => {
    if (editVenue) {
      ...
      setUploadedImages([]);
      setAutoGenerated(false); // Reset auto-generation flag for new venues
    }
  }, [editVenue]);
  ...
  useEffect(() => {
    ...
    // and haven't already auto-generated
    if (!isEditing && !autoGenerated && formData.openTime && formData.closeTime && 
        formData.openTime !== '00:00' && formData.closeTime !== '00:00') {
      
      console.log('🔄 Auto-generating 7 days of slots...');
      ...
      console.log('✅ Generated slots for dates:', Object.keys(newDateSlots));
      ...
      setAutoGenerated(true); // Mark as auto-generated to prevent re-triggering
    }
  }, [formData.openTime, formData.closeTime, isEditing, autoGenerated, generateAllPossibleSlots]);
